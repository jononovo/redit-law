...
function StatCard({ label, value, trend, trendUp }: { label: string, value: string, trend: string, trendUp?: boolean }) {
  return (
    <div className="bg-white p-6 rounded-xl border border-neutral-100 shadow-sm flex flex-col gap-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex flex-col gap-8 animate-fade-in-up">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 flex flex-col gap-6">
                ...
                <div className="bg-neutral-900 text-white p-6 rounded-2xl flex items-center justify-between relative overflow-hidden group cursor-pointer">
