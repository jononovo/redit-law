...
| File | URL | Purpose |
|------|-----|---------|
| **SKILL.md** (this file) | `https://creditclaw.com/shopping/skill.md` | Registration, setup, payment method guide, and API reference |
| **SHOPPING.md** | `https://creditclaw.com/shopping/shopping.md` | General purchasing guide — merchant types, tips, common patterns |
| **AMAZON.md** | `https://creditclaw.com/shopping/amazon.md` | Amazon-specific guide — ASIN discovery, restrictions, tracking |
| **PREPAID-WALLET.md** | `https://creditclaw.com/shopping/prepaid-wallet.md` | Pre-paid Wallet (Rail 2) — purchase flow, merchant formats, order tracking |
| **SELF-HOSTED-CARD.md** | `https://creditclaw.com/shopping/self-hosted-card.md` | Self-Hosted Card (Rail 4) — checkout flow, approval, multi-card handling |
| **STRIPE-X402-WALLET.md** | `https://creditclaw.com/shopping/stripe-x402-wallet.md` | Stripe x402 Wallet (Rail 1) — x402 signing, USDC balance, guardrails |
...
curl -s https://creditclaw.com/shopping/amazon.md > ~/.creditclaw/skills/shopping/AMAZON.md
curl -s https://creditclaw.com/shopping/prepaid-wallet.md > ~/.creditclaw/skills/shopping/PREPAID-WALLET.md
curl -s https://creditclaw.com/shopping/self-hosted-card.md > ~/.creditclaw/skills/shopping/SELF-HOSTED-CARD.md
...
|---------------|----------|--------|-----------------|
| **Pre-paid Wallet** | Amazon, Shopify, supported merchants | Live | [prepaid-wallet.md](https://creditclaw.com/shopping/prepaid-wallet.md) |
| **Self-Hosted Card** | SaaS, cloud hosting, any online store | Live | [self-hosted-card.md](https://creditclaw.com/shopping/self-hosted-card.md) |
| **Stripe x402 Wallet** | x402 services, agent-to-agent payments | Private Beta | [stripe-x402-wallet.md](https://creditclaw.com/shopping/stripe-x402-wallet.md) |
...
**For general shopping advice and tips, see [shopping.md](https://creditclaw.com/shopping/shopping.md).**
...
**Full guide:** [prepaid-wallet.md](https://creditclaw.com/shopping/prepaid-wallet.md)
...
**Full guide:** [self-hosted-card.md](https://creditclaw.com/shopping/self-hosted-card.md)
...
**Full guide:** [stripe-x402-wallet.md](https://creditclaw.com/shopping/stripe-x402-wallet.md)
