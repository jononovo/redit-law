...
Companion to [skill.md](https://creditclaw.com/shopping/skill.md). Covers how to make purchases using the Pre-paid Wallet (Rail 2) for Amazon, Shopify, and supported merchants.
...
For complete Amazon details (ASIN discovery, product validation, restrictions), see [amazon.md](https://creditclaw.com/shopping/amazon.md).
