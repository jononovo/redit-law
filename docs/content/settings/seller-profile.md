...
|---------|-------------|
| **Checkout Pages** | Business name, logo, and contact email |
| **Invoices** | Business name and logo in the header |
| **Public Shop** | Business name, logo, and description |
| **Payment Links** | Business name and logo |
